...
class Jugador {
    ...
    public void moverAPosicion(int indiceTransformerEnMovimiento, Posicion destino) {
        Algoformer algoformerEnMovimiento = this.obtenerAlgoformer(indiceTransformerEnMovimiento);
